package com.spepc.updateapp;// package name;
...
public  class UpdateChecker {
    public static final String APP_CHECK = "https://www.pgyer.com/apiv2/app/check";//检测App是否有更新
    public static final String APP_GROUP = "https://www.pgyer.com/apiv2/appGroup/listAll"; //这里说的分组，指的是开发者在「应用管理」-「我的分组」中设置的App分组。
    ...
    public void check(String appKey, String buildVersion, Integer buildBuildVersion, String channelKey, Callback callback) {
        ...
        Http.post(APP_CHECK, data, new Http.Callback() {
            ...
            public Boolean response(String response) {
                ...
                updateInfo.appURL = dataMap.get("appURL");
    ...
    public class UpdateInfo {
        ...
        public String toString(){
            return "needForceUpdate:"+needForceUpdate+","
